...
changeColor.onclick = function toggleBG() {
  ...
  if (clicked) {
    ...
    document.documentElement.style.setProperty("--skillsBg", "#0a0a0a");
    document.querySelector(".img-overlay").style.backgroundColor = "#00000050";
    clicked = false;
  } else {
    document.documentElement.style.setProperty("--bg", "#607ea0");
    document.documentElement.style.setProperty("--skillsBg", "#cfe1ee");
    document.querySelector(".img-overlay").style.backgroundColor = "#00000038";
    clicked = true;
  }
};
...
//     document.querySelector(".navbar-mobile-fixed").style.top = "0";
//     openIcon.style.top = "20px";
//     document.querySelector(".nav-logo-link").style.top = "20px";
//   } else {
//     // document.getElementById("navbar").style.top = "-50px";
//     document.querySelector(".navbar-mobile-fixed").style.top = "-90px";
//     openIcon.style.top = "-70px";
//     document.querySelector(".nav-logo-link").style.top = "-70px";
//   }
...
function sendEmail() {
  ...
  emailjs.send("contact_us", "template_vpatf3o", tempParams).then(function () {
    console.log("succes", res.status);
  });
  document.querySelector(".email-send").style.transform =
